...
const SearchBar = () => {
    return (
        <div className="w-[95%] m-auto px-[10px] md:w-[80%] lg:w-[65%] py-[20px] relative flex items-center">
            <input type="search" className="w-full h-[46px] rounded-full px-[10px] text-[14px] lg:text-[16px] border border-[#FFCA9A] focus:outline-none" placeholder="Search for a movie, tv show, person..." />
